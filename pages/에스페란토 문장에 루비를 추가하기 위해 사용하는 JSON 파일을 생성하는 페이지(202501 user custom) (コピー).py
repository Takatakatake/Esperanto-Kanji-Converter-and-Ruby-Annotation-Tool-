...
with open(json_file_path, "rb") as file_json:
    btn_json = st.download_button(
        label="샘플 JSON 파일 1 다운로드(世界语 단어 어근 분해법 사용자 설정)",
        data=file_json,
...
selected_display = st.selectbox('출력 형식 선택:', display_options)
...
if uploaded_file is not None:
    ...
    input_csv_file="./files_needed_to_get_replacements_list_json_format/世界语词根列表＿user.csv"
