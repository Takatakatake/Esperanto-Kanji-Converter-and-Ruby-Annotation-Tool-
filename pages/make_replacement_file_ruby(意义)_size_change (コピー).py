...
with open(file_path0, "rb") as file:
    btn = st.download_button(
            label="下载示例CSV文件0(한국어 번역 루비 리스트)",
            data=file,
            file_name="한국어 번역 루비 리스트_202501.csv",
            mime="text/csv"
        )
# サンプルファイルのパス
file_path1 = './files_needed_to_get_replacements_list_json_format/Ruby格式＿中文.csv'
# ファイルを読み込む
...
# サンプルファイルのパス
file_path2 = './files_needed_to_get_replacements_list_json_format/日本語ルビ20241211.csv'
# ファイルを読み込む
with open(file_path2, "rb") as file:
    btn = st.download_button(
            label="下载示例CSV文件2(日本語ルビ20241211)",
            data=file,
